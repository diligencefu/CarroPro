...
class LNFormView: UIView {
    ...
    private func configSubviews() {
        ...
        for index in 0..<datas.count {
            ...
            let valueView = UIView.init(frame: CGRect.init(x: kWidth/5*3, y: kTop, width: kWidth/5*2, height: kHeight))
            ...
            let title = UILabel.init(frame: CGRect.init(x: 0, y: valueView.ln_y, width: kWidth/5*3, height: valueView.ln_height))
